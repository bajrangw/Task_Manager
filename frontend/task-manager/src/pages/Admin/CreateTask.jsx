    ...
    try {
      ...
      if (response.data) {
        ...
        setTaskData((prevState) => ({
          ...
          : null,
          assignedTo: taskInfo?.assignedTo?.map((items) => items?._id) || [],
          todoChecklist:
      ...
      <div className="mt-5">
        <div className="grid grid-cols-1 md:grid-cols-4 mt-4">
          ...
          <div className="mt-3">
            ...
            <textarea
              placeholder="Discribe about the task..."
              className="form-input"
              rows={4}
          ...
          <div className="grid grid-cols-12 gap-4 mt-2">
            ...
            <div className="col-span-6 md:col-span-4">
              ...
              onChange={({ target }) => 
                handleValueChange("dueDate", target.value ? moment(target.value).toISOString() : null)
            }
              type="date"
              />
            </div>
